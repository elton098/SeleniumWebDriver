...
public static void setTestLength(String time){
    Wait.waitForElementVisibility(By.cssSelector(".time-limit-multiplier.form-control"),20);
    ...
    Wait.waitForElementVisibility(By.xpath(".//*[@id='content-player']/div/div/div[2]/div/div/div[2]/div/button"),20);
    ...
    public static void exitExamAndDisplayScore(){
        ...
        Wait.waitForElementVisibility(By.cssSelector(".btn.btn-sm.btn-default-eval.section-btn-end"),20);
        ...
        Wait.sleep(8000);
        Wait.waitForElementVisibility(By.xpath(".//*[@id='tpr-practice']/div[1]/div[2]/div[2]/div/div[2]/h1"),20);
    ...
    public static void testPostExamFunctions(){
       ...
       //web page needs 20-60 seconds to load the report or it will keep creating a dialog
        ...
        Wait.waitForElementVisibility(By.linkText("SAT Essay"),20);
